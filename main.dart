...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      title: 'assessment1_6701213065_sulaimanhafizh',
      theme: ThemeData(
        primarySwatch: Colors.blue,
      ),
      home: const MyHomePage(title: 'Stock Code: SBUX'),
    );
  }
}
...
class _MyHomePageState extends State<MyHomePage> {
  Future<List<SahamPoint>> getPoints() async {
    final apiKey = 'fLdgQST2phVrFnsuxlAX6giv1B078Mdd';
    final stockSymbol = 'SBUX';
